...
def create_table(session):
    session.execute("""
        CREATE TABLE IF NOT EXISTS spark_streams.user_automation (
            id UUID PRIMARY KEY,
            first_name TEXT,
            last_name TEXT,
            gender TEXT,
...
def insert_data(session, **kwargs):
    ...
    try:
        session.execute("""
                INSERT INTO spark_streams.user_automation(id, first_name, last_name, gender, address, 
